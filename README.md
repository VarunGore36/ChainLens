...
[![Tests](https://img.shields.io/badge/Tests-232_passing-22c55e)]()
...
| Tests | **232 passing**, 0 clippy warnings |
...
```bash
cargo test --locked                              # 232 tests
cargo clippy --locked --all-targets -- -D warnings
cargo fmt --all -- --check
cargo bench --bench decode -- --quick
```

**Coverage:** config (26) · decode (25) · rpc (27) · store (13) · intelligence (78) · integration (7) · crash recovery (5) · other (4)
